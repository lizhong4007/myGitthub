                                  ...
                                  <label class="d_region control-label distributor_region">
                                   ...
                                   <div class="d_select_block">
                                      <select class="form-control select2 d_province" name="distributor[{$distributor.distributorid}][countryid]">
                                        ...
                                        <option title="{$country_v.en_name}"  value="{$country_v.countryid}" <if condition="$distributor['countryid'] eq $country_v['countryid']">selected="selected"</if> >{$country_v.letter}:{$country_v.cn_name}{$country_v.en_name}</option>
                                        </foreach>
                                      </select>
                                      ...
                                      <select class="form-control select2 d_city" name="distributor[{$distributor.distributorid}][stateid]">
                                        ...
                                        <option title="{$state.en_name}"  value="{$state.stateid}" <if condition="$distributor['stateid'] eq $state['stateid']">selected="selected"</if> >{$state.letter}:{$state.cn_name}{$state.en_name}</option>
                                        </foreach>
                                      </select>
                                      ...
                                      <select class="form-control select2" name="distributor[{$distributor.distributorid}][cityid]">
                                        ...
                                        <option title="{$city.en_name}"  value="{$city.cityid}" <if condition="$distributor['cityid'] eq $city['cityid']">selected="selected"</if> >{$city.letter}:{$city.cn_name}{$city.en_name}</option>
                                        </foreach>
                                      </select>
                                  </div>
                                </div>
