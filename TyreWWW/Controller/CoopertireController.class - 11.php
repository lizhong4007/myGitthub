            ...
            if(!empty($value_tr))
            {
                ...
                //型号
                 ...
                 if(!empty($model_arr_td[1][8]))
                  ...
                  // {
                  //   $this->addGoodSpec(array('允许使用轮辋'=>$model_arr_td[1][10]));
                  // }

                  // $biao = '';
                  // $biao = $model_arr_td[1][11];
                  // if(!empty($biao))
                  // {
                  ...
                  //  if(!empty($model_arr_td[1][13]))
                  // {
                  //   $this->addGoodSpec(array('断面宽度'=>$model_arr_td[1][13]));
                  // }

                  //  if(!empty($model_arr_td[1][14]))
                  // {
                  //   $zhijing = '';
                  //   $zhijing = $model_arr_td[1][14];
